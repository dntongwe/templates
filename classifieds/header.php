...
<section class="navigation"
         data-enable_sticky="<?php echo $enable_sticky == 'yes' ? esc_attr__( 'yes' ) : esc_attr__( 'no' ) ?>">
	<div class="container">
		<div class="clearfix">
			<div class="pull-left">
				<?php
				...
				if ( ! empty( $site_logo['url'] ) ): ?>
					<a href="<?php echo esc_url( home_url( '/' ) ); ?>" class="site-logo">
						<img src="<?php echo esc_url( $site_logo['url'] ); ?>" title="" alt=""
						     width="<?php echo esc_attr__( $site_logo['width'] ) ?>"
						     height="<?php echo esc_attr__( $site_logo['height'] ) ?>">
					</a>
				<?php endif; ?>
			</div>
